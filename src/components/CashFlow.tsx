        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const }}>국민연금 개시 나이</span>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const }}>국민연금 월액 (67세 기준)</span>
            ...
            <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 24 }}>
              ...
              <div style={{ backgroundColor: '#fff7ed', borderRadius: 12, padding: 20, border: '1px solid #fed7aa' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  ...
                  <p style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const }}>
              ...
              <div style={{ backgroundColor: '#fdf2f8', borderRadius: 12, padding: 20, border: '2px solid #f9a8d4' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  ...
                  <div style={{ backgroundColor: 'var(--bg-primary)', borderRadius: 8, padding: 12, border: '1px solid #fbcfe8' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8, fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const }}>
