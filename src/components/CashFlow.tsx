    ...
    <>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
          {/* 기본설정 */}
          <div style={{ display: 'grid', gridTemplateColumns: '80px repeat(4, 1fr)', gap: '0 20px', alignItems: 'start' }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--accent-blue)', padding: '10px 0', gridRow: '1 / 3' }}>기본설정</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>시작 년도</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>{isCoupleMode ? '본인 은퇴 시작 나이' : '은퇴 시작 나이'}</span>
          ...
          {isCoupleMode && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
              <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>배우자 은퇴 시작 나이</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>물가상승률 (%)</span>
          ...
          {/* 생활비 */}
          <div style={{ display: 'grid', gridTemplateColumns: '80px repeat(4, 1fr)', gap: '0 20px', alignItems: 'start', marginTop: 8 }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--accent-blue)', padding: '10px 0' }}>생활비</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>75세 이전 월 생활비</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>75세 이후 월 생활비</span>
          ...
          {/* 자산 */}
          <div style={{ display: 'grid', gridTemplateColumns: '80px repeat(4, 1fr)', gap: '0 20px', alignItems: 'start', marginTop: 8 }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--accent-blue)', padding: '10px 0', gridRow: '1 / 3' }}>자산</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>남편 ISA</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>아내 ISA</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>해외직투금액</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>주택 시가</span>
          ...
          {/* 수익률 */}
          <div style={{ display: 'grid', gridTemplateColumns: '80px repeat(4, 1fr)', gap: '0 20px', alignItems: 'start', marginTop: 8 }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--accent-blue)', padding: '10px 0' }}>수익률</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>ISA 연수익률 (%)</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>해외주식 연수익률 (%)</span>
          ...
          {/* 연금 */}
          <div style={{ display: 'grid', gridTemplateColumns: '80px repeat(4, 1fr)', gap: '0 20px', alignItems: 'start', marginTop: 8 }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--accent-blue)', padding: '10px 0', gridRow: '1 / 4' }}>연금</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>연금계좌 합계</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>연금 인출 금액 (월)</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>연금 연수익률 (%)</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>연금소진 모드</span>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>연금 개시 나이</span>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>국민연금 개시 나이</span>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>국민연금 월액 (67세 기준)</span>
          ...
          {/* 주택연금 */}
          <div style={{ display: 'grid', gridTemplateColumns: '80px repeat(4, 1fr)', gap: '0 20px', alignItems: 'start', marginTop: 8 }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--accent-blue)', padding: '10px 0' }}>주택연금</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>주택연금 개시 나이</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>주택연금 월수령액</span>
          ...
          {/* 생명보험 */}
          <div style={{ display: 'grid', gridTemplateColumns: '80px repeat(4, 1fr)', gap: '0 20px', alignItems: 'start', marginTop: 8 }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--accent-blue)', padding: '10px 0' }}>생명보험</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>생명보험연금 개시 나이</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', borderBottom: '1px solid var(--border-secondary)' }}>
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>생명보험연금 연수령액</span>
            ...
            <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 24 }}>
              ...
              <div style={{ backgroundColor: '#fff7ed', borderRadius: 12, padding: 20, border: '1px solid #fed7aa' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  ...
                  <p style={{ fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>
              ...
              <div style={{ backgroundColor: '#fdf2f8', borderRadius: 12, padding: 20, border: '2px solid #f9a8d4' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  ...
                  <div style={{ backgroundColor: 'var(--bg-primary)', borderRadius: 8, padding: 12, border: '1px solid #fbcfe8' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8, fontSize: 13, color: 'var(--text-secondary)', whiteSpace: 'nowrap' as const, flex: 1, textAlign: 'right' as const }}>
